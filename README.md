...
<div align="center">
  <img src="src/Assets/icon_256.png" alt="ClipPanda Logo" width="128" />
</div>
...
最新版本下载：[GitHub Releases](https://github.com/1vanFan/ClipPanda/releases/latest)

下载 `ClipPanda_x.x.x_win-x64.zip` 并解压，直接运行 `ClipPanda.exe` 即可。
...
2. **克隆或下载项目**
   ```bash
   git clone https://github.com/1vanFan/ClipPanda.git
   cd ClipPanda
   ```
...
- 日志位置：`%LocalAppData%\ClipPanda\logs\`
- 默认保留天数：7 天
- 默认最大条数：500 条
